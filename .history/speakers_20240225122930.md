...
- {:.item_l1} **Connor	Coley**    | *MIT*      
    ...
    <br>   
 - {:.item_l2} **David	Balcells** | *Pacific Northwest National Laboratory*      
    Accelerating Atomic-scale Simulations ofDavid	Balcells Molecules and Materials with Neural Network Potentials    
    <br>      
